...
class ScanScreen extends StatefulWidget {
  ...
  final String deviceIDSubstring;

  const ScanScreen({Key? key, required this.deviceIDSubstring}) : super(key: key);
...
class _ScanScreenState extends State<ScanScreen> {
  ...
  void initState() {
    ...
    FlutterBluePlus.systemDevices(withServices).then((devices) {
  ...
  Widget deviceListViewBuilder(){
    ...
    for(ScanResult r in _scanResults) {
      if(r.advertisementData.localName.toLowerCase().contains(widget.deviceIDSubstring.toLowerCase())){
        results.add(r);
      }
    }
