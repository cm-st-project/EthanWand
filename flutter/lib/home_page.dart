...
import 'demo/demodevicelistpage.dart';
...
class _State extends State{
  ...
  final deviceIDSubstring = "Golden";
  ...
  Widget HomeBody(){
    return Center(
      child:
      // DemoListView()
      _adapterState == BluetoothAdapterState.on ? ScanScreen(deviceIDSubstring: deviceIDSubstring) : blueToothOffWidget(),
  ...
  Widget build(context){
    return Scaffold(
      appBar: AppBar(title: const Text('IllumiVoice'),),
      body: HomeBody(),
